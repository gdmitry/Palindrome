...
"bundle";
$__System.registerDynamic("0", ["1"], true, function(require, exports, module) {
  ;
  var global = this,
...
define("1", ["2", "3", "4"], function($, palindrome, display) {
  'use strict';
  $(".form").submit(function(event) {
    ...
    $.each(collection, function(index, input) {
      inputs[input.name] = (input.type === 'radio' || input.type === 'checkbox') ? input.checked : input.value;
    });
